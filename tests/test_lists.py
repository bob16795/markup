    ...
    * e
    ...
    nodes = str(markup.nodes.BodyNode([
      markup.nodes.ListNode([
        markup.nodes.Node("TEXT", " a \t", 3),
        markup.nodes.Node("LIST2", "", 1),
        markup.nodes.Node("TEXT", " b \t\t", 3),
        markup.nodes.Node("LIST3", "", 1),
        markup.nodes.Node("TEXT", " c \t", 3),
        markup.nodes.Node("LIST2", "", 1),
        markup.nodes.Node("TEXT", " d ", 2),
        markup.nodes.Node("LIST1", "", 1),
        markup.nodes.Node("TEXT", "e \t\t", 3),
        markup.nodes.Node("LIST3", "", 1),
